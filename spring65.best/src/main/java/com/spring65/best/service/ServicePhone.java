package com.spring65.best.service;
...
import com.spring65.best.dao.IDaoPhone;
...
public class ServicePhone implements IServicePhone {
    ...
    @Override
    public int inserPhoneList(List<ModelPhone> phones) {
        int result = -1; 
        
        try {
            result = dao.inserPhoneList(phones);
        } catch (Exception e) {
            // TODO Auto-generated catch block
            // e.printStackTrace();
            logger.error("inserPhoneList" + e.getMessage() );
            throw e;
        }
